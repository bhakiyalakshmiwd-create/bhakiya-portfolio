...
export default function Contact() {
  return (
    <section id="contact" style={{ padding: '4rem 2rem', maxWidth: 1050, margin: '0 auto' }}>
      <p style={{
      ...
      <div style={{
        ...
        <div>
          <h3 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.6rem' }}>
            Open to new opportunities 🚀
          </h3>
          <p style={{ color: '#6b6b90', fontSize: '0.88rem', lineHeight: 1.7 }}>
            Available from July 2026 for freelance React projects or full-time roles.
            2.8 years of real-world experience in CRM, e-commerce & GRC platforms.
          </p>
        </div>
